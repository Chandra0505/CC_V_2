...
certificate_print_text($pdf, $x, $y + 36, 'C', $fontsans, '', 30, "Chandra Prakash");
certificate_print_text($pdf, $x, $y + 55, 'C', $fontsans, '', 20, "has successfully been declared awesome in");
certificate_print_text($pdf, $x, $y + 72, 'C', $fontsans, '', 20, "INDUSTRY 4.0");
certificate_print_text($pdf, $x, $y + 92, 'C', $fontsans, '', 14,  "13th June 2020");
certificate_print_text($pdf, $x, $y + 102, 'C', $fontserif, '', 10, "With a grade of 90%");
